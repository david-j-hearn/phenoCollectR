...
#'   \item AnnualMonthlyAverageTemp. The Annual Monthly Average Temperature in Celsius.
#'   \item SpringMonthlyAverageTemp. The Monthly Average Temperature for the Spring months in Celsius.
